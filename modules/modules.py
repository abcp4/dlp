...
class PointNetPPToCNN(nn.Module):
    def __init__(self, axis_dim=2, target_hw=16, n_kp=8, pad_mode='replicate', with_fps=False, features_dim=2,patch_size=8):
        ...
        # num_upsample = int(np.log2(patch_size[0])) - 3  # thanks @MoritzLange
        num_upsample = int(np.log2(patch_size)) - 3  # thanks @MoritzLange
